...
<body>
   <div id="adminNav" class="container d-flex justify-content-center align-items-center" style="min-height: 100vh">
      <nav>
        <div class="nav-bar">
            ...
            <div class="menu">
                ...
                <ul class="nav-links">
                    ...
                    <li class="dropdown">
                        <a href="#" class="toggle">Report <i class='bx bx-chevron-down'></i></a>
                        <ul class="sub-menu">
                            <li><a href="report_list.php">Report List</a></li>
                            <li><a href="report_analyst.php">Report Data Analysis</a></li>
                            <li><a href="report_total.php">Total Report</a></li>
                        </ul>
                    </li>
